...
export function createLlmClient(config: AppConfig, esClient: Client, logger: ReturnType<typeof createLogger>): LlmClient | undefined {
...
export async function startHandler(opts: Record<string, unknown>, _deps: { program: Command }): Promise<void> {
